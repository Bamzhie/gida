        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              A Lagos-first property marketplace preview, with more of the country planned later.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/how-it-works" className="hover:text-foreground">How Gida works</Link></li>
              <li><Link href="/cost-guide" className="hover:text-foreground">Cost guide</Link></li>
              <li><Link href="/trust" className="hover:text-foreground">Trust model</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                Lagos
                <span className="text-xs rounded-full bg-accent/15 text-accent px-2 py-0.5">Preview</span>
              </li>
              <li className="flex items-center gap-2">
                Abuja
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/how-it-works" className="hover:text-foreground">Help centre</Link></li>
